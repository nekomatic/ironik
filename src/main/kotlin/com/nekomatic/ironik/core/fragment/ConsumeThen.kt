...
infix fun <TStreamItem : Any, TInput : IInput<TStreamItem>> fragmentParser<TStreamItem, TInput>.consumeThen(that: fragmentParser<TStreamItem, TInput>): fragmentParser<TStreamItem, TInput> =
